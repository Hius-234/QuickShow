...
const SeatLayout = () => {
    ...
    const bookTickets = async ()=>{
        try {
            if(!user) return toast.error('Plaese login to proceed')

                if(!selectedTime || !selectedSeats.length) return toast.error('Plaease select a time and seats');
    ...
    return show ? (
        <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
            {/* Available Timings */}
            <div className='w-60 bg-primary/10 borsder border-primary/20 rounded-lg py-10 h-max md:sticky md:top-30'>
